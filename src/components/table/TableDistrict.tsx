...
const TableDistrict = ({ value }: Iprops) => {
            ...
            <table className="w-full border">
                <thead className="border">
                    <tr className="border ">
                        ...
                        <th className="border">Tên Huyện</th>
                        ...
                        value.results.map((e: any, index) => (
                            <tr className="border" key={index}>
                                ...
                                <td className="border text-center p-3">
                                    <Link href={`/city/${e.province_id}/${e.district_id}`}>{e.district_name}</Link>
                                </td>
                                <td className="border text-center">{e.district_type}</td>
                            </tr>
                        ))
                    }
                </tbody>
